...
FIELD_SPECS = [
    ...
    {'key': 'display_mode', 'source': 'yaml', 'type': 'select',
     'label': 'Display Mode', 'options': ['scoreboard', 'linescore', 'fields', 'scorecard', 'derby', 'quadrant']},
    {'key': 'DISPLAY_MODE', 'source': 'env', 'type': 'select',
     'label': 'Display Mode Override (.env)', 'options': ['', 'scoreboard', 'linescore', 'fields', 'scorecard', 'derby', 'quadrant'],
