...
FIELD_SPECS = [
    ...
    {'key': 'display_mode', 'source': 'yaml', 'type': 'select',
     'label': 'Display Mode', 'options': ['scoreboard', 'linescore', 'fields', 'scorecard', 'pitch', 'derby', 'quadrant']},
    {'key': 'DISPLAY_MODE', 'source': 'env', 'type': 'select',
     'label': 'Display Mode Override (.env)', 'options': ['', 'scoreboard', 'linescore', 'fields', 'scorecard', 'pitch', 'derby', 'quadrant'],
     'help': 'Overrides Display Mode above when set. Leave blank to use it.'},
    {'key': 'morning_alternate_quadrant', 'source': 'yaml', 'type': 'bool',
     'label': 'Morning: Include Quadrant',
     'help': 'Three-way morning rotation: today → yesterday → quadrant, 5 min each.'},
    {'key': 'quadrant_grain', 'source': 'yaml', 'type': 'select',
     'label': 'Quadrant Window', 'options': ['season', 'month', 'week', 'rotate'],
     'help': 'Which window the quadrant chart plots. "rotate" cycles all three.'},
    {'key': 'quadrant_rotate_minutes', 'source': 'yaml', 'type': 'text',
     'label': 'Quadrant Rotate (min)', 'help': 'Minutes per window when Quadrant Window is "rotate".'},
    ...
    {'key': 'replay_step_minutes', 'source': 'yaml', 'type': 'text',
