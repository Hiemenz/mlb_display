...
GAMES = [
    _live_game(1, 147, 111, 3, 2, 'Fenway Park',
        ...
        current_hitter='Rafael Devers',
        current_play_batter='Rafael Devers',
        runner_on_first='Jarren Duran',
        runner_on_third='Wilyer Abreu',
        runner_first_number=16,
        runner_third_number=52,
        pitch_count=78,
        last_pitch_type='SL',
        last_pitch_speed=86.2,
        batter_hits=1,
    ...
    _live_game(2, 119, 137, 5, 4, 'Oracle Park',
        current_pitcher='Yoshinobu Yamamoto',
        current_hitter='Matt Chapman',
        current_play_batter='Matt Chapman',
        runner_on_first='Heliot Ramos',
        runner_on_third='Jung Hoo Lee',
        runner_first_number=17,
        runner_third_number=51,
        pitch_count=92,
        last_pitch_type='FB',
        last_pitch_speed=95.4,
        batter_hits=2,
        batter_at_bats=4,
        ab_pitches=[
            {'seq': 1, 'px': 0.4, 'pz': 3.1, 'sz_top': 3.4, 'sz_bot': 1.6, 'code': 'B', 'pt_abbr': 'FB'},
            {'seq': 2, 'px': -0.6, 'pz': 1.9, 'sz_top': 3.4, 'sz_bot': 1.6, 'code': 'S', 'pt_abbr': 'CB'},
        ],
        half_inning_plays=['1B', '2B'],
        home_pitcher_ks=['K', 'L', 'K'],
        away_pitcher_ks=['K', 'K', 'L'],
        away_win_probability=61.0,
        home_win_probability=39.0,
    ),
    _live_game(3, 133, 144, 1, 0, 'Truist Park',
        current_pitcher='JP Sears',
        current_hitter='Ronald Acuña Jr.',
        current_play_batter='Ronald Acuña Jr.',
        runner_on_first='Ozzie Albies',
        runner_on_third='Austin Riley',
        runner_first_number=1,
        runner_third_number=27,
        pitch_count=64,
        last_pitch_type='CH',
        last_pitch_speed=83.7,
        batter_hits=0,
        batter_at_bats=2,
        ab_pitches=[
            {'seq': 1, 'px': -0.1, 'pz': 2.6, 'sz_top': 3.4, 'sz_bot': 1.6, 'code': 'S', 'pt_abbr': 'SL'},
            {'seq': 2, 'px': 0.2, 'pz': 1.4, 'sz_top': 3.4, 'sz_bot': 1.6, 'code': 'B', 'pt_abbr': 'CH'},
        ],
        half_inning_plays=['K', 'K'],
        home_pitcher_ks=['L', 'K'],
        away_pitcher_ks=['K', 'K', 'K'],
